...
<h1 style="background-color:gray">Sign Up Now!<span>It is completely free and will take less then 30 Seconds!!</span></h1>
</div>
</div>
...
include "connect.php";
 ...
 $errors = array();
    ...
    else
    {
        ...
        $db=new PDO("mysql:host=localhost;dbname=ideashare","root","");
        if($db)
        {
             $sql = "INSERT INTO
